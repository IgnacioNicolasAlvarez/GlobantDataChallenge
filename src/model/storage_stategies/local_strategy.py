...
class LocalStrategy(Strategy):
    def __init__(self, avro_data_path: str, avro_schema_file: str, file_name: str):
    ...
    def create_snapshot(self, data: list) -> list:
        avro_writer = AvroWriter(
            avro_data_path=self.avro_data_path, avro_schema_file=self.avro_schema_file, file_name=self.file_name
        )
